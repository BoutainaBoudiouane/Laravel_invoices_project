							...
							<div class="row">
								<div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
									<div class="card-sigin">
										<div class="mb-5 d-flex"> <a href="{{ url('/' . $page='Home') }}"><img src="{{URL::asset('assets/img/brand/logoB.png')}}" class="sign-favicon ht-40" alt="logo"></a>&nbsp;&nbsp;<h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">Quick<span>In</span>vo</h1></div>
										<div class="card-sigin">
