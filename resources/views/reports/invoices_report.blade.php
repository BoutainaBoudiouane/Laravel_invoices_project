...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
                <h4 class="content-title mb-0 my-auto" style="color: #333; font-size: 35px; margin-bottom: 10px;">التقارير</h4>
			<span class="text-muted mt-1 tx-13 mr-2 mb-0" style="color: #333; font-size: 25px; margin-bottom: 10px;"> / تقرير
                الفواتير</span>
        </div>
    </div>
</div>
                    ...
                    <div class="row">
                        <div class="col-lg-3 mg-t-20 mg-lg-t-0" id="type">
                            ...
                            <select class="form-control select2" name="type" required>
                                ...
                                <!-- pre-select an option :If $type is set, it will use its value; 
                                otherwise, it defaults to the specified text in Arabic ('حدد نوع الفواتير'). -->
