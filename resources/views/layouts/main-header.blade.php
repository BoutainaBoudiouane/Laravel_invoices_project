	...
	<div class="container-fluid">
		<div class="main-header-left ">
			<div class="responsive-logo">
				...
				<a href="{{ url('/' . $page='home') }}"><img src="{{URL::asset('assets/img/brand/logoB.png')}}" class="logo-2" alt="logo"></a>
			...
			<form action="{{route('searchPage')}}" method="GET">
				...
				<div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
					<input class="form-control" placeholder="ابحث عن الصفحة..." type="search" name='search'> <button class="btn"><i class="fas fa-search d-none d-md-block"></i></button>
				</div>
			</form>
		</div>
			...
			<div class="nav nav-item  navbar-nav-right ml-auto">
					...
					<div class="dropdown-menu">
						<div class="menu-header-content bg-primary text-right">
							...
							<h6 style="color: yellow" id="notifications_count">
								<!-- count of number unread invoices added (read_at = Null)-->
				...
				<div class="dropdown main-profile-menu nav nav-item nav-link">
					...
					<div class="dropdown-menu">
						...
						<a class="dropdown-item" href="{{ route('show_profile', Auth::user()->id) }}"><i class="bx bx-user-circle"></i>Profile</a>
